...
<div align="center" class="menus">
	<a href="home.html" class="button morado">
		<span class="icon-home"></span>Inicio
		</a>

	<a href="somos.html" class="button red">
		<span class="icon-users"></span>¿Quienes Somos?
		</a>

	<a href="productos.html" class="button morado">
		<span class="icon-shopping-cart"></span>Productos
		</a>

	<a href="fundacion.html" class="button red">
		<span class="icon-emoji-happy"></span>Fundación Apo
		</a>

	<a href="contactenos.html" class="button morado">
